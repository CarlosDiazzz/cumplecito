...
const OrigamiLily = () => {
  ...
  useEffect(() => {
    layerRefs.current.forEach((layer, i) => {
      if (layer) {
        gsap.to(layer, {
          attr: { d: isOpen ? LILY_PATHS.open[i] : LILY_PATHS.closed },
          duration: 1.5,
  ...
  return (
    <div className="flex flex-col items-center justify-center cursor-pointer select-none group animate-fade-in" onClick={() => setIsOpen(!isOpen)}>
